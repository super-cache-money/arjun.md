...
We prefer a handful of companies - because the fewer apps that have our data, the less likely exposed we feel. 
...
**1. An active community of technical users hacking away in it**
...
**2. A break-out to heavy users of ChatGPT et al, with a polished, managed product**
